...
export default function AgentLoginPage({ onNavigate }: AgentLoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!agent) {
      ...
      setError('No agent account found for this email. Please register first.');
      setLoading(false);
      return;
    }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary-700 to-primary-600 px-8 py-8 text-white text-center">
            ...
            <p className="text-white/80 mt-1 text-sm">Sign in to your agent account</p>
          </div>
